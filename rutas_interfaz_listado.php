...
$cnslt=mysql_query("SELECT rt.id, rt.id_origen as idori, rt.id_destino iddes, rt.duracion_hrs as hr, rt.duracion_min as min,  ori.nombre as origen, des.nombre as destino, rt.precio, rt.activo, rt.ruta_larga  as rl FROM ruta rt INNER JOIN ciudad ori ON rt.id_origen=ori.id INNER JOIN ciudad des ON rt.id_destino=des.id ORDER BY rt.duracion_hrs");
                                    ...
                                    <?php 
                                      ...
                                      ?>
                                        <tr>
                                            ...
                                            <td><? echo $fl["rl"]; ?></td>
                                            <td><? echo $fl["activo"];?></td>
                                            <td><button title="Editar" type="button" data-rl="<? echo $fl["rl"]; ?>" data-ori="<? echo $fl["origen"];?>" data-des="<? echo $fl["destino"];?>" data-hr="<? echo $fl["hr"]; ?>" data-min="<? echo $fl["min"]; ?>" data-idori="<? echo $fl["idori"]; ?>" data-iddes="<? echo $fl["iddes"]; ?>" data-precio="<? echo $fl["precio"]; ?>" data-activo="<? echo $fl["activo"]; ?>" data-id="<? echo $fl["id"]; ?>" class="editar btn btn-warning"><span class="glyphicon glyphicon-pencil"></span></button>
                                            - 
                                            <?
                                            $idr=$fl["id"];
                                            $cnslt2=mysql_query("SELECT * FROM ruta_horario WHERE id_ruta=$idr");
                                            ?>



                                            <button title="Actualizar Horario" type="button" data-nreg="<? echo mysql_num_rows($cnslt2); ?>"  data-id="<? echo $fl["id"]; ?>" class="act-hor btn btn-danger"><span class="glyphicon glyphicon-time"></span></button></td>
                                        </tr>
                                        <?php 
      ...
      <div class="modal-body">
        <div class="container">
                        ...
                        <form role="form" class="form-horizontal" id="frmrut">
                            ...
                            <div class="form-group">
                                <label for="" class="col-sm-2 control-label">Reserva</label>
                                  <div class="col-sm-1">
