...
<div class="panel panel-primary">
  <div class="panel-heading">
    <h2 class="panel-title"><span align="right" class="glyphicon glyphicon-search"></span><b>&nbsp;&nbsp;BUSCAR RESERVAS</b></h2>
  </div>
    ...
    <div class="container">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input name="fres" id="fres" type="date" min="<?php echo date("Y-m-d");?>" max="<?php echo date_format($fres, 'Y-m-d'); ?>" value="<?php echo date("Y-m-d");?>" class="form-control" />  
                                </div>
                            ...
                            <div class="form-group" align="center">
                                    ...
                                    <label><a id="buscar3" class="btn btn-primary">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Buscar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></label>
                                                ...
                                                <table id="tabla" class="table table-striped table-bordered" align="center" cellspacing="0" width="100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th bgcolor="#D9D9D9" width="5%">Editar</th>
